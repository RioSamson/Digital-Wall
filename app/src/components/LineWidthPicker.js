...
// SVG components for default and selected line widths
 ...
 * 
 * This component provides a UI for selecting the line width. It displays different line width options
 * as buttons, and highlights the currently selected width.
 * 
 * @param {Object} props - The properties passed to the component
 * @param {Function} props.setWidth - Function to set the line width
 * @param {number} props.lineWidth - The currently selected line width
 * @param {boolean} props.showLineWidthPopup - Determines if the line width popup should be shown
 * @returns {JSX.Element|null} The LineWidthPicker component or null if showLineWidthPopup is false
 */
    ...
    <div className="lineWidthPopup" style={{ display: "flex", flexDirection: "column", padding: "10px", background: "#fff", border: "none", width: "250px"}}>
      <div style={{ marginTop: "5px", textAlign: "center" }}>
        <div style={{ display: "flex", justifyContent: "center" }}>
          {/* Render buttons for each line width option */}
