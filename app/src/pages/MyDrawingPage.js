...
/**
 * MyDrawingPage component
 * 
 * This component displays the user's drawings for a selected scene. It allows users to view their
 * drawings in a modal and navigate to a live display page.
 * 
 * @component
 * @example
 * return (
    ...
    >
      ...
      >
        {drawings.length > 0 ? (
          ...
          <p style={{ fontWeight: 500, fontSize: "24px", marginLeft: "20px", color:"black" }}>
            No drawings found
          </p>
        )}
      </div>
